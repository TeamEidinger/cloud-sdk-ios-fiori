...
let package = Package(
    ...
    targets: [
        .target(
            name: "FioriSwiftUI",
            dependencies: [.target(name: "FioriSwiftUICore", condition: .when(platforms: [.iOS, .visionOS, .macCatalyst]))]
        ),
        .target(
            name: "FioriCharts",
        ...
        .target(
            ...
            dependencies: [
                .target(name: "FioriThemeManager", condition: .when(platforms: [.iOS, .visionOS, .macCatalyst])),
                .target(name: "FioriCharts", condition: .when(platforms: [.iOS, .visionOS, .macCatalyst]))
            ],
